...
import AboutDialog from "../overlay/dialog/AboutDialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
        ...
        >
          ...
          >
            ...
            <Link to="/docs">
              ...
              >
                <LuBookOpen className="mr-2 size-4 text-primary" />
            ...
            <MenuItem
              ...
              aria-label="About ANDRO-Vision"
              onClick={() => setAboutDialogOpen(true)}
            >
              <LuInfo className="mr-2 size-4 text-primary" />
              <span>About ANDRO-Vision</span>
            </MenuItem>
            {isAdmin && (
              <>
                <DropdownMenuSeparator
