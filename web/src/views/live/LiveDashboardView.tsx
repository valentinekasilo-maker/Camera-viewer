...
export default function LiveDashboardView({
  ...
  const activeStreams = useMemo(() => {
    ...
    cameras.forEach((camera) => {
      ...
      const subStream =
        Object.values(availableStreams).find((s) => s.endsWith("_sub")) ||
        Object.values(availableStreams)[0] ||
        "";

      const streamName = streamExists ? streamNameFromSettings : subStream;
  ...
  const handleError = useCallback(
    (cameraName: string, _error: LivePlayerError) => {
