...
def migrate_frigate_config(config_file: str):
    ...
    backup_dir = os.path.dirname(config_file) if os.path.isdir(os.path.dirname(config_file)) else CONFIG_DIR
    shutil.copy(config_file, os.path.join(backup_dir, "backup_config.yaml"))
    new_config = config
